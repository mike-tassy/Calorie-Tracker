class CalorieTracker {
  constructor() {
    ...
    this._displayClaoriesProgress();

    document.getElementById("limit").value = this._calorieLimit;
  }

  //These are public methods / apis
  ...
  _dispayCaloriesRemaining() {
    ...
    if (remaining <= 0) {
      caloriesRemaningEl.parentElement.parentElement.classList.remove(
        "bg-light"
      );
      ...
      progressEl.classList.remove("bg-remove");
      progressEl.classList.add("bg-success");
    }
  }

  _displayClaoriesProgress() {
    const progressEl = document.getElementById("calorie-progress");
...
class Storage {
  ...
  static updateTotalCalories(caloris) {
    localStorage.setItem("totalCalories", caloris);
  }
  ...
  static clearAll() {
    ...
    // if you wamt to include the limit
    //localStorage.clear()
  }
}
